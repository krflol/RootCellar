...
19. Dual-read migration drill gate integrated into nightly workflow (`python/validate_batch_dual_read_migration.py`) with full artifact-family matrix coverage, artifact-subset policy knob control, and manifest exposure.
- Remaining:
