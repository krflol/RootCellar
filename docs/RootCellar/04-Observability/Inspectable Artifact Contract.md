...
- Nightly manifest includes dual-read drill policy state, artifact matrix, staged-wave policy, fault-injection policy, and report publication fields (`alert_policy_schema_migration_drill_validation_enabled`, `alert_policy_schema_migration_drill_artifacts`, `alert_policy_schema_migration_drill_wave_spec`, `alert_policy_schema_migration_drill_fault_injection_enabled`, `alert_policy_schema_migration_drill_fault_scenarios`, `schema_migration_drill_report_generated`).
