...
| S04-SCRIPT-01 | Epic 04 | Python worker lifecycle + sandboxing | Sprint 04 / 07 | [~] In progress | [[docs/RootCellar/03-Implementation/Python Scripting Host Design]], [[docs/RootCellar/03-Implementation/Security and Permission Model]], [[docs/RootCellar/02-Sprints/Sprint 04 - Python Macros Alpha]], [[crates/rootcellar-cli/src/main.rs]], [[crates/rootcellar-cli/src/script.rs]] |
| S04-SCRIPT-02 | Epic 04 | Macro/event invocation and audit logs | Sprint 04 / 07 | [~] In progress | [[docs/RootCellar/03-Implementation/Python Scripting Host Design]], [[docs/RootCellar/01-Epics/Epic 04 - Python Automation Platform]], [[python/worker_stub.py]], [[docs/RootCellar/00-Program/Execution Status]] |
