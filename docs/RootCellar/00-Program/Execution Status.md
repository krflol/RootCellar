...
24. Adapter export schema validation and compatibility-version contracts delivered:
   ...
   - Nightly workflow now runs adapter schema/contract validation (`Validate adapter export schemas and version contracts`) and captures schema validation config in manifest metadata.
25. Baseline test suite passing in offline mode.
