...
- [ ] Sprint 02 parser/dependency-graph core is in progress.
  ...
  Current state: parser, dependency graph, incremental invalidation, DAG timing + analysis artifacts, expanded starter function set, AST interning scaffold, and configurable slow-node thresholds are implemented; function parity expansion and scheduler/perf hardening are pending.
